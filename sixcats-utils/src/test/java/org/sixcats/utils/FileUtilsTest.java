...
public class FileUtilsTest {
	...
	assertTrue(FileUtils.isAncestor(new File("/foo/bar"), new File(
		"/foo/bar")));
    }
	...
	assertFalse(FileUtils.isAncestor(new File("/foo/bar"), new File(
		"/bar/foo")));
    }
	...
	assertEquals("", FileUtils.getRelativePath(new File("/foo/bar"),
		new File("/foo/bar")));
    }
